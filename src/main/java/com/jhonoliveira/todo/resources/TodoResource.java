package com.jhonoliveira.todo.resources;
...
import com.jhonoliveira.todo.services.TodoService;
...
public class TodoResource {
	...
	public ResponseEntity<Todo> update(@PathVariable Integer id, @RequestBody Todo obj){
		Todo newObje = todoService.update(id, obj);
		return ResponseEntity.ok(newObje);
	}
